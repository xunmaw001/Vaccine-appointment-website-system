<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#3CB371","height":"200rpx"}'>
            ...
            <view class="setting" :style='{"color":"#008761","fontSize":"40rpx"}'>
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#008761","borderColor":"#3CB371","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
