    ...
    <view class="content">
        ...
        <view class="forget-btn">
            <button class="landing"
                    :style='{"borderColor":"#ccc","backgroundColor":"#008761","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'
