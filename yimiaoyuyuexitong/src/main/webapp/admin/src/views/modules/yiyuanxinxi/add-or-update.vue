               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医院名称" prop="yiyuanxinxiName">
                       <el-input v-model="ruleForm.yiyuanxinxiName"
                                 placeholder="医院名称" clearable  :readonly="ro.yiyuanxinxiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="医院类型" prop="yiyuanxinxiTypes">
                        <el-select v-model="ruleForm.yiyuanxinxiTypes" :disabled="ro.yiyuanxinxiTypes" placeholder="请选择医院类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="yiyuanxinxiPhone">
                       <el-input v-model="ruleForm.yiyuanxinxiPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.yiyuanxinxiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医院详情" prop="yiyuanxinxiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yiyuanxinxiContent" label="医院详情" prop="yiyuanxinxiContent">
                            <span v-html="ruleForm.yiyuanxinxiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    yiyuanxinxiName: false,
                    yiyuanxinxiTypes: false,
                    yiyuanxinxiPhone: false,
                    addressTypes: false,
                    yiyuanxinxiPhoto: false,
                    yiyuanxinxiContent: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
